...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative pt-12 pb-24 lg:pt-20 lg:pb-32 overflow-hidden" id="hero-section">
      {/* Ambient background glow (solid - no gradients) */}
      <div className="absolute top-10 left-10 w-72 h-72 bg-cyan-950/20 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-cyan-500/30 text-xs font-semibold text-cyan-300 mb-6 shadow-sm">
            ...
            <span>Quotex Algo Bot Platform v2.4</span>
            <span className="text-slate-500">•</span>
            <span className="text-slate-400">Binary Options Automation</span>
          </div>
          ...
          <p className="mt-6 text-lg sm:text-xl text-slate-300 leading-relaxed">
            Run automated Quotex bots and institutional binary options algorithms natively on your Windows PC and monitor every trade live on your Android mobile app. Zero latency, full control of your capital.
          </p>
          ...
          <div className="mt-9 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button
              ...
              className="w-full sm:w-auto px-7 py-4 rounded-xl font-semibold text-sm bg-slate-900 hover:bg-slate-800 border border-slate-700 text-slate-200 transition-colors flex items-center justify-center gap-2 cursor-pointer"
        ...
        <div className="mt-14 relative max-w-5xl mx-auto">
          <div className="glass-panel rounded-2xl p-4 sm:p-6 border border-slate-700/80 shadow-2xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div>
                  ...
                  <div className="bg-slate-950 rounded-lg p-3 font-mono text-[11px] text-slate-300 space-y-1.5 border border-slate-900">
                    <div className="text-slate-500">
                      [10:14:02.112] Quotex Bot Core initialized. Cloud licensing verified (Plan: Active).
                    </div>
                    ...
                    <div className="text-slate-400">
                      [10:14:05.109] Binary options algo computed on 1-min candles. Signal: CALL / HIGHER
                    </div>
                    <div className="text-cyan-300">
                      [10:14:15.004] Executed Quotex trade TRD-8821: CALL EUR/USD @ {eurUsdPrice} (Binary Options 60s)
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:col-span-5 bg-[#0c1222] rounded-xl p-4 border border-slate-700/60 shadow-xl flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-800">
                    ...
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-slate-900 border border-cyan-500/40 text-cyan-300">
                      Wi-Fi Direct
                    </span>
                  </div>
                  ...
                  <div className="bg-slate-950/90 rounded-xl p-3 border border-slate-800 mb-3">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-[11px] text-slate-400">Active Quotex Session</span>
                    ...
                    <div className="text-xl font-black text-white font-mono flex items-baseline gap-2">
                      <span>EUR/USD</span>
                      <span className="text-xs text-emerald-400">Quotex Signal: CALL</span>
                    </div>
                    <div className="text-xs text-slate-400 mt-1">
                      Target Payout: &gt;85% • Binary Options 60s
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-950 rounded-xl p-3 border border-slate-800/80 mb-3">
                    <div className="flex justify-between text-[10px] text-slate-400 mb-1">
                      <span>1M Quotex Bot Overlay</span>
                      <span className="text-cyan-400 font-mono">Binary Options Algo</span>
                    </div>
